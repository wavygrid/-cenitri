...
export const VoiceScale: React.FC = () => {
  return (
    <section id="voice-scale" className="py-24 lg:py-32 bg-cream" aria-labelledby="voice-scale-heading">
        ...
        <div className="flex flex-col md:flex-row items-center gap-16">
            ...
            <div className="md:w-1/2">
                <div className="flex items-center gap-4 mb-6">
                    ...
                    <span className="text-sm leading-normal font-semibold uppercase tracking-wider text-slate-600">Scale Capacity</span>
                </div>

                <h2 id="voice-scale-heading" className="text-3xl md:text-4xl font-bold leading-tight text-slate-900 mb-6">
                ...
                <div className="flex flex-wrap gap-2">
                    <span className="bg-stone-100 px-3 py-1 rounded-full text-sm leading-normal font-medium text-slate-700">Handles 50+ calls at once</span>
                    <span className="bg-stone-100 px-3 py-1 rounded-full text-sm leading-normal font-medium text-slate-700">Perfect English & Spanish</span>
                </div>
            </div>
                        ...
                        <div className="w-full space-y-4">
                            ...
                            <div className="bg-white/5 p-4 rounded-xl backdrop-blur-sm border border-white/5">
                                <div className="flex items-center gap-2 mb-2">
                                    ...
                                    <span className="text-xs leading-normal font-semibold text-slate-400 uppercase">Live Call - 0:14</span>
                                </div>
                            ...
                            <div className="flex justify-center gap-4 pt-4">
                                ...
                                <button className="h-12 px-6 rounded-full bg-red-500/20 text-red-400 font-semibold text-sm leading-normal flex items-center justify-center border border-red-500/30">
                                    End Demo
                                </button>
                            </div>
                        </div>
