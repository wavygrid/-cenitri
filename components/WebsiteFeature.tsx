...
export const WebsiteFeature: React.FC = () => {
  return (
    <section id="website-feature" className="py-24 lg:py-32 bg-white border-t border-slate-100" aria-labelledby="website-feature-heading">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="text-center mb-16">
            <h2 id="website-feature-heading" className="text-3xl md:text-4xl font-bold leading-tight text-slate-900">Feature 1: The Frontend</h2>
            <p className="text-lg leading-relaxed text-slate-700 mt-2">Replaces: WordPress, Webflow, Wix, SEO Agencies.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="p-8 rounded-2xl bg-slate-50 border border-slate-200">
                ...
                <h3 className="text-xl font-semibold leading-snug text-slate-900 mb-3">App-Like Experience</h3>
            ...
            <div className="p-8 rounded-2xl bg-slate-50 border border-slate-200">
                ...
                <h3 className="text-xl font-semibold leading-snug text-slate-900 mb-3">Instant Load Times</h3>
                <p className="text-slate-700 text-sm leading-relaxed">
