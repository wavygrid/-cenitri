...
export const StorefrontBuilder: React.FC = () => {
  return (
    <section id="storefront" className="py-24 lg:py-32 bg-white overflow-hidden border-b border-slate-100" aria-labelledby="storefront-heading">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row items-center gap-20">

            <div className="lg:w-1/2">
                <span className="text-brand-600 font-semibold tracking-widest uppercase text-xs leading-normal mb-4 block">Online Presence</span>
                <h2 id="storefront-heading" className="text-3xl md:text-4xl font-bold leading-tight text-slate-900 mb-6">
                    Look like a national brand. <br/>
                    <span className="text-slate-600">Without the agency fees.</span>
                </h2>
                    ...
                    <div className="bg-white rounded-[2.5rem] overflow-hidden h-[640px] w-full relative">
                        ...
                        <div className="p-6 pt-12">
                             <div className="flex justify-between items-center mb-6">
                                 <div className="font-semibold text-lg leading-snug text-slate-900">Apex Plumbing</div>
                                 <div className="h-8 w-8 bg-slate-100 rounded-full"></div>
                             </div>
                             <div className="bg-slate-50 rounded-3xl p-6 mb-6 text-center border border-slate-100">
                                 <h3 className="font-semibold text-2xl leading-snug mb-2 text-slate-900">Emergency?</h3>
                                 <p className="text-slate-600 text-sm leading-normal mb-4">We can be there in 2 hours.</p>
                                 <button className="bg-brand-600 text-white w-full py-3.5 rounded-2xl font-semibold shadow-lg shadow-brand-200 hover:bg-brand-700 transition-colors">Book Now</button>
                             </div>
