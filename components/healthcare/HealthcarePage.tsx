...
const HealthcareHero = ({ onNavigate }: { onNavigate?: (page: PageView) => void }) => (
  <section className="relative pt-28 pb-16 md:pt-48 md:pb-32 overflow-hidden bg-gradient-to-b from-white to-teal-50/30">
    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl text-center">
      ...
      >
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-teal-50 border border-teal-100 text-teal-800 text-lg font-medium uppercase tracking-wider mb-8">
       ...
       <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-20">
          <div className="flex flex-wrap justify-center gap-y-6 gap-x-12 md:gap-x-16">
            <div className="flex items-center space-x-3 text-slate-700">
              ...
              <span className="text-lg font-semibold">HIPAA Compliant Architecture</span>
            </div>
            <div className="flex items-center space-x-3 text-slate-700">
              <DatabaseIcon className="w-5 h-5 text-teal-600" />
              <span className="text-lg font-semibold">US Data Sovereignty</span>
            </div>
            <div className="flex items-center space-x-3 text-slate-700">
              <FileXIcon className="w-5 h-5 text-teal-600" />
              <span className="text-lg font-semibold">Zero Retention Protocol</span>
            </div>
          </div>
        </div>
    </div>
      ...
      <div className="flex flex-col lg:flex-row gap-10 lg:gap-20 items-center">
        <div className="w-full lg:w-1/2">
           ...
           <div className="bg-red-50 border-l-4 border-red-500 p-6 rounded-r-lg">
             ...
             <p className="text-red-800/90 text-lg leading-relaxed">
    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8">
         ...
         <div className="bg-white rounded-2xl border border-slate-200 p-6 md:p-8 shadow-sm hover:shadow-md transition-shadow">
            ...
            <div className="text-lg font-medium text-blue-600 uppercase tracking-wide mb-4">PDPM Revenue Integrity</div>
         ...
         <div className="bg-white rounded-2xl border border-slate-200 p-6 md:p-8 shadow-sm hover:shadow-md transition-shadow">
            ...
            <div className="text-lg font-medium text-teal-600 uppercase tracking-wide mb-4">Pre Claim Review Support</div>
         ...
         <div className="bg-white rounded-2xl border border-slate-200 p-6 md:p-8 shadow-sm hover:shadow-md transition-shadow">
            ...
            <div className="text-lg font-medium text-purple-600 uppercase tracking-wide mb-4">Audit Efficiency</div>
       ...
       <div className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-20">
          ...
          <div className="flex gap-6">
             ...
             <div>
                ...
                <div className="text-lg font-medium text-slate-500 uppercase mb-2">Reads the Unreadable</div>
                <p className="text-slate-600 leading-relaxed text-lg md:text-base">
          ...
          <div className="flex gap-6">
             ...
             <div>
                ...
                <div className="text-lg font-medium text-slate-500 uppercase mb-2">Source Verification</div>
                <p className="text-slate-600 leading-relaxed text-lg md:text-base">
          ...
          <div className="flex gap-6">
             ...
             <div>
                ...
                <div className="text-lg font-medium text-slate-500 uppercase mb-2">Clinical Context</div>
                <p className="text-slate-600 leading-relaxed text-lg md:text-base">
          ...
          <div className="flex gap-6">
             ...
             <div>
                ...
                <div className="text-lg font-medium text-slate-500 uppercase mb-2">Impact Scoring</div>
                <p className="text-slate-600 leading-relaxed text-lg md:text-base">
