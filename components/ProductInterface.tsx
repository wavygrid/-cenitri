            ...
            <div className="bg-white rounded-lg shadow-2xl overflow-hidden ring-1 ring-white/10">
                ...
                <div className="bg-slate-50 border-b border-slate-200 px-6 py-4 flex items-center gap-4">
                    ...
                    <div className="flex-1 text-center">
                        <span className="text-lg font-medium text-slate-500 uppercase tracking-widest">CENTURIM CASE VIEWER v2.4</span>
                    </div>
                ...
                <div className="flex flex-col md:flex-row h-auto md:h-[600px] relative text-left">
                    ...
                    <div className="w-full md:w-72 border-r border-slate-200 bg-slate-50/50 p-6 hidden md:flex flex-col gap-6">
                         <div className="text-lg font-medium text-slate-500 uppercase tracking-widest mb-2">Source Files</div>
                    ...
                    <div className="flex-1 bg-white p-8 flex flex-col">
                         ...
                         <div className="flex justify-between items-end mb-8 border-b border-slate-100 pb-6">
                             ...
                             <div className="flex gap-4">
                                <div className="px-4 py-2 bg-slate-100 text-slate-700 text-lg font-medium uppercase tracking-wider rounded border border-slate-200">
                                    Export PDF
                                </div>
                                <div className="px-4 py-2 bg-emerald-50 text-emerald-700 border border-emerald-200 text-lg font-medium uppercase tracking-wider rounded">
                                    Analysis Complete
                                </div>
                             </div>
                         </div>
                         ...
                         <div className="border border-slate-200 rounded-lg overflow-hidden flex-1 flex flex-col">
                             <div className="bg-slate-50 border-b border-slate-200 px-8 py-4 grid grid-cols-12 text-lg font-medium text-slate-500 uppercase tracking-wider">
                             ...
                             <div className="divide-y divide-slate-100 bg-white">
                                 {[1, 2, 3].map((i) => (
                                     <div key={i} className="px-8 py-6 grid grid-cols-12 text-base items-center hover:bg-slate-50 transition-colors">
                                         <div className="col-span-2 font-mono text-slate-600 font-medium text-lg">Oct 12, 2023</div>
                                         <div className="col-span-3 text-slate-900 font-medium text-lg">St. Mary's Hospital</div>
                                         <div className="col-span-5 text-slate-600 truncate pr-6 text-lg font-medium">
                                             Patient admitted with complaints of severe headache...
                                         </div>
                                         <div className="col-span-2 text-right">
                                             <span className="text-[#2563EB] font-medium text-lg uppercase tracking-wide cursor-pointer hover:underline">Page {14 + i * 4}</span>
                                         </div>
                                     </div>
                                 ))}
                             </div>
