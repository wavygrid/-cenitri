        ...
        <div className="flex flex-col md:flex-row items-center gap-16">
            ...
            <div className="md:w-1/2">
                <div className="flex items-center gap-4 mb-6">
                    ...
                    <span className="text-sm font-bold uppercase tracking-wider text-stone-400">Capture & Convert</span>
                </div>
                ...
                <p className="text-lg text-stone-600 mb-8 leading-relaxed">
                    Most trade websites are static brochures. We build you a <strong className="text-stone-900">Progressive Web App (PWA)</strong> that feels like a native app. It loads instantly, works offline, and is designed to get the "Book Now" click.
                </p>
                ...
                <div className="space-y-4">
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            <h4 className="font-bold text-stone-900">Programmatic SEO</h4>
                            <p className="text-sm text-stone-500">We auto-generate landing pages for every suburb you service.</p>
                        </div>
                    </div>
                    <div className="flex items-start gap-4">
                        <div className="mt-1 bg-green-100 p-1 rounded-full"><ArrowRight className="h-3 w-3 text-green-700" /></div>
                        <div>
                            <h4 className="font-bold text-stone-900">Trust-First Design</h4>
                            <p className="text-sm text-stone-500">Reviews, licenses, and insurance badges are front and center.</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div className="bg-white rounded-[2.5rem] overflow-hidden h-[550px] relative">
                        ...
                        <div className="bg-stone-900 text-white p-6 pt-12">
                            <div className="flex justify-between items-center mb-4">
                                <span className="font-bold text-lg">Mike's Plumbing</span>
                        ...
                        <div className="p-6 space-y-4">
                            <div className="bg-stone-50 p-4 rounded-2xl border border-stone-100 flex items-center gap-3">
                                ...
                                <div className="text-sm font-bold text-stone-800">Leak Repair</div>
                            </div>
                            <div className="bg-stone-50 p-4 rounded-2xl border border-stone-100 flex items-center gap-3">
                                <div className="h-10 w-10 bg-white rounded-full flex items-center justify-center shadow-sm">🔥</div>
                                <div className="text-sm font-bold text-stone-800">Water Heater</div>
                            </div>
                            <button className="w-full bg-brand-600 text-white font-bold py-4 rounded-xl shadow-lg shadow-brand-500/30 mt-4">
                                Book Now
                            </button>
