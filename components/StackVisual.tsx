    ...
    <section className="py-24 bg-white border-y border-stone-100 overflow-hidden relative">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="text-center mb-24">
            <h2 className="text-4xl font-display font-bold text-stone-900 mb-6">Stop Juggling. Start Flowing.</h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-0 relative z-10">
                ...
                <div className="flex flex-col items-center">
                    <div className="bg-white p-6 rounded-3xl border border-stone-200 shadow-card w-full max-w-sm relative group hover:-translate-y-2 transition-transform duration-300">
                        <div className="absolute -top-3 -left-3 bg-stone-900 text-white h-8 w-8 rounded-full flex items-center justify-center font-bold text-sm">1</div>
                        <h3 className="font-bold text-lg mb-4 text-stone-900">The Input</h3>
                        <div className="space-y-3">
                            <div className="flex items-center gap-3 p-3 bg-stone-50 rounded-xl border border-stone-100">
                                <div className="h-2 w-2 rounded-full bg-blue-500"></div>
                                <span className="text-sm font-medium text-stone-600">Website Visitor</span>
                            </div>
                            <div className="flex items-center gap-3 p-3 bg-stone-50 rounded-xl border border-stone-100">
                                <div className="h-2 w-2 rounded-full bg-green-500"></div>
                                <span className="text-sm font-medium text-stone-600">Missed Phone Call</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex flex-col items-center justify-center">
                    <div className="bg-brand-600 p-8 rounded-[2.5rem] shadow-2xl shadow-brand-500/30 w-full max-w-xs text-center text-white relative scale-110">
                        ...
                        <div className="relative z-10">
                            ...
                            <h3 className="font-bold text-2xl mb-2">The Engine</h3>
                            <p className="text-brand-100 text-sm">Processing Logic, Pricing & Dispatch</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex flex-col items-center">
                    <div className="bg-white p-6 rounded-3xl border border-stone-200 shadow-card w-full max-w-sm relative group hover:-translate-y-2 transition-transform duration-300">
                         <div className="absolute -top-3 -right-3 bg-green-500 text-white h-8 w-8 rounded-full flex items-center justify-center font-bold text-sm"><CheckCircle2 className="h-4 w-4"/></div>
                        <h3 className="font-bold text-lg mb-4 text-stone-900">The Result</h3>
                        <div className="space-y-3">
                            <div className="flex items-center justify-between p-3 bg-green-50 rounded-xl border border-green-100">
                                <span className="text-sm font-bold text-green-900">Job Booked</span>
                                <span className="text-xs bg-white px-2 py-1 rounded text-green-700 font-bold">4:00 PM</span>
                            </div>
                            <div className="flex items-center justify-between p-3 bg-green-50 rounded-xl border border-green-100">
                                <span className="text-sm font-bold text-green-900">Deposit Paid</span>
                                <span className="text-xs bg-white px-2 py-1 rounded text-green-700 font-bold">+$50.00</span>
                            </div>
                        </div>
                    </div>
                </div>
