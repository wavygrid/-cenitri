...
export const TheStruggle: React.FC = () => {
  return (
    <section className="py-24 lg:py-32 bg-white" aria-labelledby="struggle-heading">
       <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mb-12">
              <h2 id="struggle-heading" className="text-3xl md:text-4xl font-bold leading-tight uppercase mb-4">Why you are tired.</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
              <div className="border-2 border-black p-8 bg-gray-50">
                  <h3 className="text-xl font-semibold leading-snug mb-3 uppercase">Phone Tag</h3>
                  ...
                  <div className="font-bold text-base leading-normal border-t-2 border-black pt-4">
                     Result: You lose the job.
                  </div>
              </div>

              <div className="border-2 border-black p-8 bg-gray-50">
                  <h3 className="text-xl font-semibold leading-snug mb-3 uppercase">Evening Paperwork</h3>
                  <p className="text-base leading-relaxed text-slate-700 mb-4">
              ...
              <div className="border-2 border-black p-8 bg-gray-50">
                  <h3 className="text-xl font-semibold leading-snug mb-3 uppercase">Tyre Kickers</h3>
                  <p className="text-base leading-relaxed text-slate-700 mb-4">
