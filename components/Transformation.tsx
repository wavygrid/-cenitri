          ...
          <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
            <div className="w-full lg:w-1/2 order-2 lg:order-1">
                ...
                <div className="bg-white p-10 border border-slate-200 shadow-xl rounded-2xl">
                    <div className="flex items-center justify-between mb-10 pb-6 border-b border-slate-100">
                         <div className="text-lg font-medium text-slate-500 uppercase tracking-widest">Clinical Timeline</div>
                    ...
                    <div className="space-y-0">
                         <div className="flex gap-6 pb-10 relative">
                             ...
                             <div className="flex-1 bg-slate-50 p-6 rounded-lg border border-slate-100">
                                 <div className="text-lg font-medium text-slate-500 mb-2">May 12, 2023</div>
                         ...
                         <div className="flex gap-6 relative">
                             ...
                             <div className="flex-1 bg-white p-6 rounded-lg border border-blue-100 shadow-sm">
                                 <div className="text-lg font-medium text-blue-600 mb-2">May 14, 2023</div>
            ...
            <div className="w-full lg:w-1/2 order-1 lg:order-2">
                <div className="flex items-center gap-4 mb-8">
                    ...
                    <span className="text-lg font-medium uppercase tracking-widest text-slate-600">Linear Analysis</span>
                </div>
                {/* text-4xl -> text-3xl */}
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
            <div className="w-full lg:w-1/2">
                <div className="flex items-center gap-4 mb-8">
                    ...
                    <span className="text-lg font-medium uppercase tracking-widest text-slate-600">Conflict Detection</span>
                </div>
                {/* text-4xl -> text-3xl */}
                ...
                <div className="bg-white p-10 border border-slate-200 shadow-xl rounded-2xl">
                    <div className="flex items-center justify-between mb-10 pb-6 border-b border-slate-100">
                         <div className="flex items-center gap-3 text-orange-700">
                             ...
                             <span className="text-lg font-medium uppercase tracking-widest">Contradiction Detected</span>
                         </div>
                         <div className="px-3 py-1 bg-orange-50 text-orange-800 text-lg font-medium uppercase rounded border border-orange-200">High Priority</div>
                    </div>
                    
                    <div className="grid grid-cols-2 gap-px bg-slate-200 border border-slate-200 rounded-lg overflow-hidden">
                        <div className="bg-white p-6">
                            <div className="text-lg font-medium text-slate-500 uppercase tracking-wide mb-3">Source A: Intake</div>
                        ...
                        <div className="bg-white p-6">
                             <div className="text-lg font-medium text-slate-500 uppercase tracking-wide mb-3">Source B: PCP Notes</div>
                            <div className="p-4 bg-slate-50 rounded border border-slate-100">
