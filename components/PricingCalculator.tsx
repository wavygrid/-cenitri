...
export const PricingCalculator: React.FC = () => {
  ...
  return (
    <section className="py-24 bg-slate-50 border-t border-slate-200" id="roi">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        
        <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-slate-900 mb-4">Revenue Recovery Projection</h2>
        ...
        <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
            <div className="grid grid-cols-1 lg:grid-cols-2">
                ...
                <div className="p-10 border-b lg:border-b-0 lg:border-r border-slate-100">
                    <h3 className="text-sm font-bold uppercase tracking-wide text-slate-400 mb-8">Operational Metrics</h3>
                    
                    <div className="space-y-10">
                        <div>
                            <div className="flex justify-between mb-4">
                                <label className="font-semibold text-slate-900">Average Job Profit</label>
                                <div className="bg-slate-100 px-3 py-1 rounded text-sm font-mono font-bold text-slate-900">${avgJobValue}</div>
                            </div>
                            <input 
                               type="range" 
                               min="100" 
                            ...
                            />
                            <p className="text-xs text-slate-500 mt-2">Net profit per completed service call.</p>
                        </div>

                        <div>
                            <div className="flex justify-between mb-4">
                                <label className="font-semibold text-slate-900">Missed Inquiries / Month</label>
                                <div className="bg-slate-100 px-3 py-1 rounded text-sm font-mono font-bold text-slate-900">{missedCalls} calls</div>
                            </div>
                             <input 
                               type="range" 
                               min="1" 
                               ...
                               className="w-full h-2 bg-slate-200 rounded-lg appearance-none cursor-pointer accent-teal-600"
                            />
                             <p className="text-xs text-slate-500 mt-2">Calls sent to voicemail or emails not replied to within 1 hour.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="p-10 bg-slate-50 flex flex-col justify-center">
                   <div className="mb-8">
                       <span className="block text-xs font-bold uppercase text-slate-500 mb-2">Estimated Monthly Loss</span>
                       <span className="block text-4xl font-bold text-slate-900">${recoveredMonthly.toLocaleString()}</span>
                   </div>
                   
                   <div className="mb-8">
                       <span className="block text-xs font-bold uppercase text-slate-500 mb-2">Annual Revenue Opportunity</span>
                       <span className="block text-5xl font-bold text-teal-600">${annualRecovered.toLocaleString()}</span>
                   </div>
