...
export const UseCases: React.FC = () => {
  return (
    <section id="use-cases" className="py-24 bg-stone-50">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        
        <div className="text-center mb-16">
           <span className="text-brand-600 font-bold tracking-wider uppercase text-xs mb-3 block">Real Scenarios</span>
           <h2 className="text-4xl font-extrabold text-stone-900 mb-6">A Tale of Two Trades</h2>
        ...
        <div className="space-y-20">
            ...
            <div className="bg-white rounded-[2.5rem] p-8 md:p-12 shadow-soft border border-stone-100 overflow-hidden relative">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div>
                        <div className="inline-flex items-center gap-2 bg-blue-50 text-blue-700 px-4 py-2 rounded-full text-xs font-bold uppercase mb-6">
                            Scenario: The Emergency Leak
                        </div>
                        <h3 className="text-3xl font-bold text-stone-900 mb-4">Meet Bob. He's a Plumber.</h3>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex gap-4 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
                                ...
                                <div>
                                    <h4 className="font-bold text-stone-900">Without Centurim</h4>
                                    <p className="text-sm text-stone-500">Bob ignores the call. He calls back 45 mins later. The customer has already booked another plumber. <br/><span className="text-red-500 font-bold">Loss: $450</span></p>
                                </div>
                            </div>
                            ...
                            <div className="flex gap-4 bg-blue-50 p-6 rounded-2xl border border-blue-100 shadow-sm transform scale-105">
                                ...
                                <div>
                                    <h4 className="font-bold text-stone-900">With Centurim AI</h4>
                                    <p className="text-sm text-stone-600">
                                        ...
                                        <br/><span className="text-blue-600 font-bold">Gain: $450 + New Client</span>
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="bg-stone-100 rounded-3xl h-full min-h-[300px] flex items-center justify-center relative overflow-hidden">
                        ...
                        <div className="w-64 bg-white rounded-2xl shadow-xl p-4 space-y-3 z-10">
                            <div className="bg-stone-100 p-3 rounded-tr-xl rounded-bl-xl rounded-br-xl text-xs text-stone-600">
                                Bob's Plumbing here. Do you have a water emergency?
                            </div>
                            <div className="bg-blue-600 p-3 rounded-tl-xl rounded-bl-xl rounded-br-xl text-xs text-white self-end ml-auto">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                     ...
                     <div className="hidden lg:flex bg-stone-100 rounded-3xl h-full min-h-[300px] items-center justify-center relative overflow-hidden">
                        ...
                        <div className="w-64 bg-white rounded-xl shadow-xl border border-stone-200 p-6 z-10 text-center">
                            <h5 className="font-bold text-stone-900 mb-1">Quote #4092</h5>
                            <div className="text-3xl font-extrabold text-stone-900 mb-4">$8,500</div>
                            <div className="flex gap-2 justify-center mb-4">
                                <span className="h-2 w-12 bg-orange-500 rounded-full"></span>
                                <span className="h-2 w-4 bg-stone-200 rounded-full"></span>
                            </div>
                            <button className="w-full bg-stone-900 text-white text-xs font-bold py-2 rounded-lg">Client Approved ✅</button>
                        </div>
                    </div>

                    <div>
                        <div className="inline-flex items-center gap-2 bg-orange-50 text-orange-700 px-4 py-2 rounded-full text-xs font-bold uppercase mb-6">
                            Scenario: The High-Ticket Quote
                        </div>
                        <h3 className="text-3xl font-bold text-stone-900 mb-4">Meet Sarah. She does HVAC.</h3>
                        <p className="text-stone-500 mb-8 leading-relaxed">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex gap-4 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
                                ...
                                <div>
                                    <h4 className="font-bold text-stone-900">Without Centurim</h4>
                                    <p className="text-sm text-stone-500">Sarah wastes 2 hours driving and quoting. The client ghosts her. <br/><span className="text-red-500 font-bold">Loss: 2 Hours + Gas</span></p>
                                </div>
                            </div>
                            ...
                            <div className="flex gap-4 bg-orange-50 p-6 rounded-2xl border border-orange-100 shadow-sm transform scale-105">
                                ...
                                <div>
                                    <h4 className="font-bold text-stone-900">With Centurim Price Wizard</h4>
                                    <p className="text-sm text-stone-600">
                                        ...
                                        <br/><span className="text-orange-600 font-bold">Gain: Qualified Lead who is ready to buy.</span>
                                    </p>
                                </div>
                            </div>
                        </div>
