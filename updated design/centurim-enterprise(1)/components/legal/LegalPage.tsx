...
const LegalHero = ({ onNavigate }: { onNavigate?: (page: PageView) => void }) => (
  <section className="relative pt-28 pb-16 md:pt-48 md:pb-32 overflow-hidden bg-gradient-to-b from-slate-50 to-white">
    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl text-center">
      ...
      >
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-slate-100 border border-slate-200 text-slate-700 text-xs font-medium uppercase tracking-wider mb-6 md:mb-8">
    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
       <div className="flex flex-wrap justify-center gap-y-6 gap-x-12 md:gap-x-16">
          <div className="flex items-center space-x-2 text-slate-600">
            ...
            <span className="text-xs md:text-sm font-medium uppercase tracking-wide">HIPAA Compliant Architecture</span>
          </div>
          <div className="flex items-center space-x-2 text-slate-600">
            <DataSovereignIcon className="w-5 h-5 text-slate-400" />
            <span className="text-xs md:text-sm font-medium uppercase tracking-wide">US Data Sovereignty</span>
          </div>
          <div className="flex items-center space-x-2 text-slate-600">
            <ZeroRetentionIcon className="w-5 h-5 text-slate-400" />
            <span className="text-xs md:text-sm font-medium uppercase tracking-wide">Zero Retention Protocol</span>
          </div>
       </div>
    </div>
  </section>
            ...
            <div className="max-w-6xl mx-auto relative">
                <div className="bg-white rounded-xl shadow-2xl border border-slate-200 overflow-hidden ring-1 ring-slate-900/5">
                    <div className="bg-[#0B1120] text-white px-4 py-3 flex items-center justify-between">
                         <div className="text-xs font-mono font-bold tracking-widest text-slate-400 uppercase hidden sm:block">Centurim Automated Medical Chronology Engine v1.0</div>
                         <div className="text-xs font-mono font-bold tracking-widest text-slate-400 uppercase sm:hidden">Centurim Engine v1.0</div>
                    ...
                    <div className="flex flex-col md:flex-row h-auto md:h-[600px] text-left">
                            ...
                            <div className="bg-white shadow-sm border border-slate-300 h-full w-full p-4 md:p-8 opacity-90 scale-95 origin-top blur-[0.5px]">
                                <div className="space-y-4 font-serif text-slate-300">
                                     ...
                                     <div className="h-32 w-full bg-slate-100 mt-8 border border-slate-200 flex items-center justify-center">
                                         <div className="text-xs text-slate-300 uppercase">X-Ray Image Placeholder</div>
                                     </div>
                                </div>
                            </div>
                        </div>
                        <div className="w-full md:w-1/2 bg-white p-0 flex flex-col min-h-[300px]">
                            <div className="p-4 border-b border-slate-100 flex justify-between items-center bg-slate-50/50">
                                <h3 className="font-medium text-slate-900 text-sm">Chronology & Facts</h3>
                                <Button variant="primary" className="h-8 px-4 text-xs">Export to Word</Button>
                            </div>
                            <div className="overflow-y-auto p-4 md:p-6 space-y-4">
                                <div className="flex gap-4 group cursor-pointer hover:bg-slate-50 p-3 rounded-lg transition-colors border border-transparent hover:border-slate-100">
                                    <div className="w-20 md:w-24 text-xs font-bold text-slate-500 pt-1 shrink-0">Oct 12, 2023</div>
                                    <div className="flex-1">
                                        <div className="flex items-center gap-2 mb-1">
                                            <span className="text-sm font-medium text-[#0B1120]">ER Admission</span>
                                        ...
                                        <p className="text-xs text-slate-600 leading-relaxed">Patient presents with severe lower back pain following MVA.</p>
                                    </div>
                                </div>
                                <div className="flex gap-4 p-3 rounded-lg bg-blue-50/50 border border-blue-100 relative">
                                    ...
                                    <div className="w-20 md:w-24 text-xs font-bold text-[#2563EB] pt-1 shrink-0">Oct 12, 2023</div>
                                    <div className="flex-1">
                                        <div className="flex items-center gap-2 mb-1">
                                            <span className="text-sm font-medium text-[#0B1120]">Radiology Report</span>
                                ...
                                <div className="flex gap-4 group cursor-pointer hover:bg-slate-50 p-3 rounded-lg transition-colors border border-transparent hover:border-slate-100">
                                    <div className="w-20 md:w-24 text-xs font-bold text-slate-500 pt-1 shrink-0">Oct 14, 2023</div>
                                    <div className="flex-1">
                                        <div className="flex items-center gap-2 mb-1">
                                            <span className="text-sm font-medium text-[#0B1120]">Orthopedic Consult</span>
                                        ...
                                        <p className="text-xs text-slate-600 leading-relaxed">Surgery recommended. Scheduling per Dr. Smith.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        {[
                            ...
                            <div key={idx} className="p-4 border border-slate-100 bg-slate-50/50 rounded-xl">
                                <h4 className="font-bold text-[#0B1120] text-sm mb-1">{item.title}</h4>
                        ...
                        <div className="absolute inset-0 flex flex-col p-8">
                            ...
                            <div className="flex-1 space-y-4">
                                ...
                                <div className="h-24 w-full bg-blue-50 border-2 border-dashed border-blue-200 rounded-lg flex items-center justify-center">
                                    <span className="text-blue-400 text-xs font-mono">SOVEREIGN_DATA_TUNNEL_ACTIVE</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
                    ...
                    <div className="bg-white border border-slate-200 rounded-2xl p-8 flex flex-col hover:shadow-lg transition-shadow">
                        <div className="mb-8">
                            ...
                            <p className="text-slate-500 text-sm">For Individual Consultants</p>
                        </div>
                        <div className="mb-8">
                            <div className="text-4xl font-medium text-[#0B1120]">$49 <span className="text-base font-normal text-slate-400">/ Case</span></div>
                            <p className="text-xs text-slate-400 mt-2">Up to 500 pages per review</p>
                        </div>
                        <Button variant="outline" className="w-full mb-8" onClick={() => onNavigate?.('contact')}>Purchase Credits</Button>
                        <div className="space-y-3">
                            <div className="flex items-center gap-2 text-xs text-slate-600"><CheckIcon className="w-3.5 h-3.5 text-teal-600"/> Rapid 2-Hour Triage</div>
                            <div className="flex items-center gap-2 text-xs text-slate-600"><CheckIcon className="w-3.5 h-3.5 text-teal-600"/> Chronology & Injury Lists</div>
                        </div>
                    </div>
                    ...
                    <div className="bg-[#0B1120] border border-slate-900 rounded-2xl p-8 flex flex-col text-white relative overflow-hidden shadow-2xl scale-105 z-10">
                        ...
                        <div className="mb-8">
                            ...
                            <p className="text-slate-400 text-sm">For Active PI Firms</p>
                        </div>
                        <div className="mb-8">
                            <div className="text-4xl font-medium">$199 <span className="text-base font-normal text-slate-400">/ Bundle</span></div>
                            <p className="text-xs text-slate-500 mt-2">Credits never expire</p>
                        </div>
                        ...
                        <div className="space-y-3">
                            <div className="flex items-center gap-2 text-xs text-slate-300"><CheckIcon className="w-3.5 h-3.5 text-[#2563EB]"/> Batch Intake Ready</div>
                            <div className="flex items-center gap-2 text-xs text-slate-300"><CheckIcon className="w-3.5 h-3.5 text-[#2563EB]"/> Priority Logic Queues</div>
                        </div>
                    </div>
                    ...
                    <div className="bg-slate-50 border border-slate-200 rounded-2xl p-8 flex flex-col hover:shadow-lg transition-shadow">
                        <div className="mb-8">
                            ...
                            <p className="text-slate-500 text-sm">For Mass Tort Operations</p>
                        </div>
                        <div className="mb-8">
                            <div className="text-4xl font-medium text-[#0B1120]">Custom</div>
                            <p className="text-xs text-slate-400 mt-2">Volume-tiered pricing</p>
                        </div>
                        <Button variant="outline" className="w-full mb-8 border-slate-300" onClick={() => onNavigate?.('contact')}>Contact Engineering</Button>
                        <div className="space-y-3">
                            <div className="flex items-center gap-2 text-xs text-slate-600"><CheckIcon className="w-3.5 h-3.5 text-teal-600"/> Full API Access</div>
                            <div className="flex items-center gap-2 text-xs text-slate-600"><CheckIcon className="w-3.5 h-3.5 text-teal-600"/> White-Glove Support</div>
                        </div>
                    </div>
                </div>
                            ...
                            <table className="w-full text-left">
                                <thead>
                                    <tr className="border-b border-slate-200">
                                        <th className="py-4 text-xs font-bold text-slate-400 uppercase tracking-widest w-1/2">Extraction Capabilities</th>
                                        <th className="py-4 text-center text-xs font-bold text-slate-400 uppercase tracking-widest">Solo</th>
                                        <th className="py-4 text-center text-xs font-bold text-slate-400 uppercase tracking-widest">Portfolio</th>
                                        <th className="py-4 text-center text-xs font-bold text-slate-400 uppercase tracking-widest">Enclave</th>
                                    </tr>
                                </thead>
                                <tbody className="divide-y divide-slate-100">
                                    {features.map((f, i) => (
                                        <tr key={i} className="group hover:bg-white transition-colors">
                                            <td className="py-4 text-sm font-medium text-slate-700">{f.name}</td>
                ...
                <div className="w-full lg:w-1/2 flex justify-center">
                    <div className="relative w-72 h-96">
                        ...
                        <div className="absolute top-0 left-0 w-full h-full bg-white border border-slate-200 rounded-lg shadow-xl flex flex-col items-center justify-center p-8 text-center">
                            ...
                            <div className="text-slate-500 text-sm">3,400+ Pages</div>
                            <div className="mt-8 w-full h-2 bg-slate-100 rounded-full overflow-hidden">
                                <div className="w-1/12 h-full bg-red-500"></div>
                            </div>
                            <div className="mt-2 text-xs text-red-500 font-bold uppercase tracking-wide">1% Processed</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl relative z-10">
             <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 items-center">
                <div className="flex-1 w-full">
                    <div className="inline-block px-3 py-1 bg-white/10 rounded-full text-xs font-bold text-teal-400 mb-6 uppercase tracking-wider border border-white/5">Automation</div>
                    ...
                    <div className="bg-slate-900 rounded-2xl border border-slate-700 shadow-2xl overflow-hidden">
                        <div className="bg-slate-800/50 px-6 py-4 flex justify-between items-center border-b border-slate-700">
                             <div className="flex items-center gap-3">
                                 ...
                                 <span className="text-xs font-mono font-bold text-slate-300 tracking-wide">SYSTEM ACTIVE</span>
                             </div>
                        ...
                        <div className="p-6 space-y-4">
                             <div className="flex justify-between items-center p-3 bg-slate-800/50 rounded-lg border border-slate-700/50">
                                 <div className="flex items-center gap-3">
                                     ...
                                     <span className="text-sm text-slate-300 font-medium">Processing Load</span>
                                 </div>
                                 <span className="text-teal-400 font-mono font-bold text-sm">12ms</span>
                             </div>
                             <div className="flex justify-between items-center p-3 bg-slate-800/50 rounded-lg border border-slate-700/50">
                                 <div className="flex items-center gap-3">
                                     <SovereignLockIcon className="w-5 h-5 text-blue-400" />
                                     <span className="text-sm text-slate-300 font-medium">Encryption</span>
                                 </div>
                                 <span className="text-blue-400 font-mono font-bold text-sm">AES-256</span>
                             </div>
                        </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 max-w-6xl mx-auto">
                ...
                <div className="bg-white rounded-2xl border border-slate-200 shadow-sm hover:shadow-md transition-shadow group overflow-hidden flex flex-col">
                    <div className="h-64 bg-slate-50 border-b border-slate-100 flex items-center justify-center relative overflow-hidden p-8">
                         <div className="w-full max-w-sm bg-white border border-slate-200 rounded-lg shadow-sm p-6 relative z-10 transform group-hover:scale-[1.02] transition-transform duration-300">
                             <div className="space-y-4 text-sm font-serif text-slate-300">
                                 <div className="h-2 w-full bg-slate-100 rounded"></div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="p-8 border border-slate-200 rounded-2xl bg-white shadow-sm hover:shadow-lg transition-shadow duration-300">
            ...
            <p className="text-slate-600 text-xs leading-relaxed font-medium">All processing occurs exclusively within AWS US East 1.</p>
          </div>
          <div className="p-8 border border-slate-200 rounded-2xl bg-white shadow-sm hover:shadow-lg transition-shadow duration-300">
            <div className="mb-6 w-12 h-12 bg-blue-50 rounded-lg flex items-center justify-center text-[#2563EB] ring-1 ring-blue-100">
            ...
            <p className="text-slate-600 text-xs leading-relaxed font-medium">Data exists in memory only for the duration of the analysis.</p>
          </div>
          <div className="p-8 border border-slate-200 rounded-2xl bg-white shadow-sm hover:shadow-lg transition-shadow duration-300">
            <div className="mb-6 w-12 h-12 bg-blue-50 rounded-lg flex items-center justify-center text-[#2563EB] ring-1 ring-blue-100">
            ...
            <p className="text-slate-600 text-xs leading-relaxed font-medium">We utilize AES 256 encryption for data at rest and TLS 1.3 for data in transit.</p>
          </div>
          <div className="p-8 border border-slate-200 rounded-2xl bg-white shadow-sm hover:shadow-lg transition-shadow duration-300">
            <div className="mb-6 w-12 h-12 bg-blue-50 rounded-lg flex items-center justify-center text-[#2563EB] ring-1 ring-blue-100">
            ...
            <p className="text-slate-600 text-xs leading-relaxed font-medium">Architecture designed to support strict non disclosure and confidentiality requirements.</p>
          </div>
        </div>
      </div>
    </section>
