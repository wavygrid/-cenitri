...
const VisualPaperStack = () => (
  <div className="relative w-full max-w-md mx-auto aspect-square bg-slate-50 rounded-2xl border border-slate-100 flex items-center justify-center p-8">
      ...
      <div className="absolute -right-4 bottom-12 bg-blue-600 text-white text-sm font-bold px-4 py-2 rounded-lg shadow-xl z-20 flex items-center gap-2">
  ...
  <div className="relative w-full max-w-md mx-auto aspect-square bg-blue-50/50 rounded-2xl border border-blue-100 flex items-center justify-center p-8">
      <div className="bg-white rounded-xl shadow-xl border border-slate-100 w-full p-6">
          <div className="flex items-start gap-4 mb-4">
              <div className="w-8 h-8 rounded-full bg-blue-100 flex items-center justify-center text-blue-600 font-bold text-sm">01</div>
              <div className="flex-1">
                  <p className="text-base font-medium text-slate-900 mb-1">Fracture of L4 Vertebrae</p>
                  <p className="text-sm text-slate-500">Confirmed via MRI imaging.</p>
              </div>
          </div>
          <div className="pl-12">
              <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-slate-50 border border-slate-200 rounded text-sm font-medium text-blue-600 hover:bg-blue-50 cursor-pointer transition-colors">
  ...
  <div className="relative w-full max-w-md mx-auto aspect-square bg-slate-50 rounded-2xl border border-slate-100 flex items-center justify-center p-8">
      <div className="relative flex flex-col items-center gap-6 w-full">
          <div className="p-4 bg-white border border-slate-200 rounded-lg shadow-sm w-48 text-center">
              <div className="text-sm font-bold text-slate-400 uppercase tracking-wider mb-1">Input</div>
          ...
          <div className="flex gap-4 w-full justify-center">
              <div className="p-3 bg-white border border-slate-200 rounded-lg shadow-sm w-32 text-center">
                  <div className="text-sm font-bold text-slate-400 uppercase mb-1">Chronology</div>
                  <div className="h-1.5 w-16 bg-blue-100 mx-auto rounded"></div>
              </div>
              <div className="p-3 bg-white border border-slate-200 rounded-lg shadow-sm w-32 text-center">
                  <div className="text-sm font-bold text-slate-400 uppercase mb-1">Red Flags</div>
  ...
  <div className="relative w-full max-w-md mx-auto aspect-square bg-slate-900 rounded-2xl border border-slate-800 flex items-center justify-center p-8 overflow-hidden">
      ...
      <div className="bg-white rounded-xl w-full p-6 shadow-2xl relative z-10">
          <div className="border-2 border-dashed border-slate-200 rounded-lg bg-slate-50 p-8 text-center">
              ...
              <p className="text-sm text-slate-500 mt-1">Supports PDF, TIFF, JPEG</p>
          </div>
          <div className="mt-4 flex justify-between items-center">
              ...
              <div className="text-sm font-bold text-green-600 uppercase tracking-wider">Secure Tunnel Ready</div>
          </div>
      </div>
  </div>
);
...
const VisualVarianceSnippet = () => (
  <div className="bg-slate-50 rounded-lg border border-slate-100 p-5 mt-auto">
     <div className="flex items-center justify-between mb-4">
        <div className="text-sm font-bold text-slate-400 uppercase tracking-wider">Discrepancy Found</div>
     ...
     <div className="space-y-2">
         <div className="bg-white border border-red-100 rounded p-3 flex justify-between items-center shadow-sm">
             ...
             <div className="text-sm font-bold text-red-500">Source</div>
         </div>
         <div className="bg-white border border-slate-200 rounded p-3 flex justify-between items-center opacity-60 grayscale">
             ...
             <div className="text-sm font-bold text-slate-400">Claim</div>
         </div>
     </div>
  </div>
);
...
const VisualRevenueSnippet = () => (
   <div className="bg-slate-50 rounded-lg border border-slate-100 p-5 mt-auto">
      <div className="flex justify-between items-end mb-4">
         ...
         <div className="text-sm font-bold text-emerald-600 bg-emerald-50 px-2 py-1 rounded border border-emerald-100">+$450</div>
      </div>
      <div className="w-full bg-slate-200 h-1.5 rounded-full overflow-hidden">
          <div className="bg-emerald-500 w-2/3 h-full rounded-full"></div>
      </div>
      <div className="flex justify-between mt-2">
          <div className="text-sm text-slate-400">Identified</div>
          <div className="text-sm text-slate-400">Captured</div>
      </div>
   </div>
);
...
const VisualRetentionSnippet = () => (
   <div className="bg-slate-50 rounded-lg border border-slate-100 p-5 mt-auto flex flex-col items-center justify-center py-8">
       ...
       <div className="text-sm font-bold text-slate-500 uppercase tracking-widest">Securely Purged</div>
   </div>
);
    ...
    <div className="bg-white min-h-screen font-sans">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
            ...
            <div className="w-full lg:w-1/2 text-left">
              ...
              {/* Subheader 21px */}
              <p className="text-[21px] text-slate-600 mb-10 leading-relaxed font-medium">
               ...
               <div className="bg-slate-50 rounded-2xl border border-slate-200 p-4 shadow-2xl">
                   <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
                       <div className="px-6 py-4 border-b border-slate-100 flex justify-between items-center bg-white">
                           <div>
                               <div className="text-sm font-bold uppercase tracking-widest text-slate-400 mb-1">System Output</div>
                           ...
                           <div className="flex gap-6">
                               ...
                               <div className="flex-1 border-l-2 border-blue-100 pl-6 pb-6 relative">
                                   ...
                                   <div className="mt-3 flex gap-2">
                                       <span className="px-2 py-1 bg-slate-100 text-slate-600 text-sm font-bold uppercase rounded border border-slate-200">ICD-10: M54.5</span>
                                   </div>
                               </div>
                           </div>
                           <div className="flex gap-6">
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            <h2 className="text-[28px] font-medium text-[#0B1120] mb-12 text-center">Operational & Technical FAQ</h2>
            <div className="space-y-4">
                {faqs.map((faq, index) => (
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                  {[
                      ...
                      <div key={i} className="bg-white p-6 rounded-xl border border-slate-200 hover:shadow-md transition-shadow cursor-pointer group h-full flex flex-col justify-between">
                          ...
                          <div className="mt-4 pt-4 border-t border-slate-100 flex items-center gap-2 text-sm font-bold text-slate-400 group-hover:text-blue-600">
