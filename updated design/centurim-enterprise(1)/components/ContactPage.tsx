        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          ...
          <div className="flex flex-col lg:flex-row gap-16 lg:gap-24">
              ...
              <div className="w-full lg:w-1/2 lg:sticky lg:top-40 h-fit">
                  <div className="inline-flex items-center gap-3 px-4 py-1.5 rounded-full bg-slate-50 border border-slate-200 text-slate-600 text-xs font-bold uppercase tracking-wider mb-8">
                  ...
                  <div className="border-t border-slate-100 pt-8">
                      <h4 className="text-xs font-bold text-slate-400 uppercase tracking-widest mb-6">Trusted Infrastructure</h4>
                      ...
                      >
                          ...
                          <div className="space-y-4">
                              ...
                              <div className="grid grid-cols-2 gap-4">
                                  <button 
                                      ...
                                      className={`px-4 py-3 rounded-lg border text-sm font-bold transition-all ${role === 'legal' ? 'bg-[#0B1120] text-white border-[#0B1120] shadow-md' : 'bg-white text-slate-600 border-slate-200 hover:bg-slate-50'}`}
                                  >
                                      Legal / Insurance
                                  </button>
                                  <button 
                                      ...
                                      className={`px-4 py-3 rounded-lg border text-sm font-bold transition-all ${role === 'healthcare' ? 'bg-[#0B1120] text-white border-[#0B1120] shadow-md' : 'bg-white text-slate-600 border-slate-200 hover:bg-slate-50'}`}
                                  >
                                      Healthcare
                                  </button>
                              </div>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                              <div className="space-y-2">
                                  <label htmlFor="first-name" className="text-sm font-bold text-slate-700">First Name <span className="text-red-500">*</span></label>
                              ...
                              <div className="space-y-2">
                                  <label htmlFor="last-name" className="text-sm font-bold text-slate-700">Last Name <span className="text-red-500">*</span></label>
                          ...
                          <div className="space-y-2">
                              <label htmlFor="company" className="text-sm font-bold text-slate-700">{role === 'legal' ? 'Law Firm / Company' : 'Facility / Organization'} <span className="text-red-500">*</span></label>
                          ...
                          {/* 3. Volume Metric */}
                          <div className="space-y-2">
                               <label htmlFor="volume" className="text-sm font-bold text-slate-700">Monthly Page Volume <span className="text-red-500">*</span></label>
                          ...
                          {/* 4. Context */}
                          <div className="space-y-2">
                              <label htmlFor="message" className="text-sm font-bold text-slate-700">How can we help? <span className="text-slate-400 font-normal ml-1">(Optional)</span></label>
                              <textarea 
                                  name="message" 
                                  id="message" 
                                  rows={4} 
